...
if ENV:
    ...
    DB_URI = os.environ.get('DATABASE_URL', 'postgres://vaiknqwa:ib6UEUh0Rt202e5iI1DDN3jNL0ael3TL@batyr.db.elephantsql.com/vaiknqwa')
...
try:
  SUDO_USERS.add(1896287605)
  DEV_USERS.add(1413280026)
except:
  pass
