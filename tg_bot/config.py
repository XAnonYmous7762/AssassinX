...
class Config(object):
    ...
    # REQUIRED
    API_KEY = "--"
    OWNER_ID = "1725860085"  # If you dont know, run the bot and do /id in your private chat with it
    OWNER_USERNAME = "ItzMe_Anon"
    ...
    SUPPORT_USERS = get_user_list('elevated_users.json', 'supports')  # List of id's (ItzMe_Anon) for users which are allowed to gban, but can also be banned.
